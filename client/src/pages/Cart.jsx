...
const KEY = "pk_test_51PTp4ZHxW8f3yUlNoQJ4UQuuXQIJ0ID50NP9nwFQ3lUx09xgcj8dU1RZOvU1lT1i2tuF9dQ7qoHiDqpHfHVBs33p00YkzgID94";
...
const TopButton = styled.button`
  ...
  &:hover {
    background-color: ${(props) =>
      props.type === "filled" ? "#228b22" : "lightgray"};
      ...
      <Wrapper>
        ...
        <Bottom>
          ...
          <Summary>
            ...
            <StripeCheckout
              name="NexCart."
              image="https://i.ibb.co/zJ3v134/Screenshot-2024-07-03-225142.png"
              billingAddress
              shippingAddress
